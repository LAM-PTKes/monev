...
class MonevAkreController extends Controller
{
    /**
    ...
    {
        $no   = 1;
        $unit = UnitKerja::whereLike('nama_unit', '%Unit Akreditasi%', caseSensitive: false)->get();
        ...
        if (count($unit) > 0) {
            ...
            return view('admin.monev.akre', compact('no', 'unit', 'mnv', 'bulan', 'ganti'));
        } else {
