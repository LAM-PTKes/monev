...
class MonevKepegController extends Controller
{
    /**
    ...
    {
        $no   = 1;
        $unit = UnitKerja::whereLike('nama_unit', '%Unit Kepegawaian%', caseSensitive: false)->get();
        ...
        if (count($unit) > 0) {
            ...
            return view('admin.monev.kepeg', compact('no', 'unit', 'mnv', 'bulan', 'ganti'));
        } else {
