...
class MonevITController extends Controller
{
    /**
    ...
    {
        $no   = 1;
        $unit = UnitKerja::whereLike('nama_unit', '%Unit IT%', caseSensitive: false)->get();
        ...
        if (count($unit) > 0) {
            ...
            return view('admin.monev.it', compact('no', 'unit', 'mnv', 'bulan', 'ganti'));
        } else {
