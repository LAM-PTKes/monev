!(function (n) {
    ...
    (e.prototype.init = function () {
        n("#timepicker").timepicker({
            ...
            n(".colorpicker-default").colorpicker({ format: "hex" }),
            n(".colorpicker-rgba").colorpicker(),
            n("#component-colorpicker").colorpicker({ format: null }),
            n("#datepicker").datepicker(),
            n("#datepicker-autoclose").datepicker({
                autoclose: !0,
                todayHighlight: !0,
            }),
            n("#datepicker-inline").datepicker(),
            n("#datepicker-multiple-date").datepicker({
                format: "mm/dd/yyyy",
                clearBtn: !0,
                multidate: !0,
                multidateSeparator: ",",
            }),
            n("#date-range").datepicker({ toggleActive: !0 }),
            n(".clockpicker").clockpicker({ donetext: "Done" }),
