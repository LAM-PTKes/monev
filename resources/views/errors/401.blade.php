                    ...
                    <div class="col-sm-9 text-center">
                        ...
                        <div class="wrapper-page">
                            ...
                            <div style="position: relative; width: 100%; height: 370px; overflow: hidden;">
                                <img src="{{ asset('web/401.svg') }}" alt=""
                                    style="width: 100%; height: 100%; object-fit: contain; display: block;">
                            </div>
                            <p class="text-muted mb-2">
                                Why not try refreshing your page? Or you can contact support at
                                <a href="mailto:admin@lamptkes.org" class="text-primary"
                                    target="_blank">admin@lamptkes.org</a>
                            </p>
