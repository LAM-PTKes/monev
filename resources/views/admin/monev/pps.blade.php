...
@section('title')
    Monev Pengembangan Pelatihan Sertifikasi
@endsection
@section('content')
    <div class="content">
                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">Monev Pengembangan Pelatihan Sertifikasi</li>
                            </ol>
                        </div>
                        <h4 class="page-title">Monev Pengembangan Pelatihan Sertifikasi</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                    ...
                    <div class="card-box table-responsive">
                        ...
                        <div class="form-group text-left mb-5">
                            ...
                            <button class="btn btn-outline-success width-md waves-effect waves-light" data-toggle="tooltip"
                                data-placement="top" title="Import Excel" data-original-title="Tooltip on top"
                                id='BtnUpload'>
                                <i class="fas fa-file-excel mr-1" style="color:black;"></i>
                            ...
                            <button class="btn btn-outline-teal width-md waves-effect waves-light" data-toggle="tooltip"
                                data-placement="top" title="Download" data-original-title="Tooltip on top" id='BtnExp'>
                                <i class="fas fa-file-excel mr-1" style="color:black;"></i>
                            ...
                            <tbody>
                                @foreach ($mnv as $k)
                                    <tr>
                                        <td>{{ $no++ }}</td>
                                        <td align='center'>
                                            <form action="{{ route('dMonevPPS', $k->id) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
    ...
    <!-- end content -->
    @include('admin.modal.pps')
@endsection
@include('admin.jsfile.datatable')
@include('admin.jsfile.monevpps')
