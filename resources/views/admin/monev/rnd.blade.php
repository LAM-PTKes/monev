...
@section('title')
    Monev Research and Development
@endsection
@section('content')
    <div class="content">
                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">Monev Research and Development</li>
                            </ol>
                        </div>
                        <h4 class="page-title">Monev Research and Development</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                            ...
                            <tbody>
                                @foreach ($mnv as $k)
                                    <tr>
                                        <td>{{ $no++ }}</td>
                                        <td align='center'>
                                            <form action="{{ route('dMonevRnD', $k->id) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
    ...
    <!-- end content -->
    @include('admin.modal.rnd')
@endsection
@include('admin.jsfile.datatable')
@include('admin.jsfile.monevrnd')
