...
@section('content')
                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">Monev IT</li>
                            </ol>
                        </div>
                        <h4 class="page-title">Monev IT</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                            ...
                            <tbody>
                                @foreach ($mnv as $k)
                                    <tr>
                                        <td>{{ $no++ }}</td>
                                        <td align='center'>
                                            <form action="{{ route('dMonevIT', $k->id) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
    ...
    <!-- end content -->
    @include('admin.modal.it')
@endsection
@include('admin.jsfile.datatable')
@include('admin.jsfile.monevit')
