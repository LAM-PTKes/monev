                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">Monev Sarana</li>
                            </ol>
                        </div>
                        <h4 class="page-title">Monev Sarana</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                            ...
                            <tbody>
                                @foreach ($mnv as $k)
                                    <tr>
                                        <td>{{ $no++ }}</td>
                                        <td align='center'>
                                            <form action="{{ route('dMonevSarana', $k->id) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
...
@include('admin.jsfile.monevsarana')
