    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.editfile', function() {
                ...
                $('#id_keu').val(data[0]);
                $('#form_keu').val(data[1]).trigger('change');
                $('#tahun_keu').datepicker('setDate', data[2]);
                $('#diveditfile').hide();
            });
            ...
            $('.dropify').on('change', function(e) {
                ...
                if (file) {
                    ...
                    if (ext !== 'xls' && ext !== 'xlsx' && ext !== 'doc' && ext !== 'docx') {
                        ...
                        toastr["error"]("File Extension .docx, .doc, .xlsx & .xls", "Error");
