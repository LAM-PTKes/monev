...
<div id="ModalUpload" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form class="form-horizontal" method="POST" action="{{ route('sMonevSPMI') }}"
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card-box">
                            ...
                            <form id="WZDD" method="POST" action="{{ route('cMonevSPMI') }}">
                                @csrf
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card-box">
                            ...
                            <form id="WZVT" method="GET" action="{{ route('eMonevSPMI') }}">
                                @csrf
...
<div id="ModalExp" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form class="form-horizontal" method="POST" action="{{ route('ExMonevSPMI') }}"
...
<div id="ModalCari" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="GET" action="{{ route('CariMonevSPMI') }}" id='FrmCari'>
                @csrf
