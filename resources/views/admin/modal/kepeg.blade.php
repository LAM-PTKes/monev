...
<div id="ModalUpload" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form class="form-horizontal" method="POST" action="{{ route('sMonevKepeg') }}"
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card-box">
                            ...
                            <form id="WZDD" method="POST" action="{{ route('cMonevKepeg') }}">
                                @csrf
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card-box">
                            ...
                            <form id="WZVT" method="GET" action="{{ route('eMonevKepeg') }}">
                                @csrf
...
<div id="ModalExp" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form class="form-horizontal" method="POST" action="{{ route('ExMonevKepeg') }}"
...
<div id="ModalCari" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="GET" action="{{ route('CariMonevKepeg') }}" id='FrmCari'>
                @csrf
