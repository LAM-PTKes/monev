...
<div id="ModalUpload" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form class="form-horizontal" method="POST" action="{{ route('sMonevPPS') }}" enctype="multipart/form-data"
                id='FrmUpload'>
                @csrf
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card-box">
                            ...
                            <form id="WZDD" method="POST" action="{{ route('cMonevPPS') }}">
                                @csrf
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card-box">
                            ...
                            <form id="WZVT" method="GET" action="{{ route('eMonevPPS') }}">
                                @csrf
...
<div id="ModalExp" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form class="form-horizontal" method="POST" action="{{ route('ExMonevPPS') }}"
...
<div id="ModalCari" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="GET" action="{{ route('CariMonevPPS') }}" id='FrmCari'>
                @csrf
