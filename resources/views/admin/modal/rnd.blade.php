...
<div id="ModalUpload" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title mt-0">Form Upload Excel</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form class="form-horizontal" method="POST" action="{{ route('sMonevRnD') }}" enctype="multipart/form-data"
                id='FrmUpload'>
                @csrf
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        <label for="file" class="col-sm-3 control-label">Upload Excel</label>
                        <div class="col-sm-9">
                            <input type="file" name='file' id='file' class="dropify" data-max-file-size="5M"
                                accept=".xlsx, .xls" required data-parsley-errors-container="#error-file" />
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card-box">
                            ...
                            <form id="WZDD" method="POST" action="{{ route('cMonevRnD') }}">
                                @csrf
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card-box">
                            ...
                            <form id="WZVT" method="GET" action="{{ route('eMonevRnD') }}">
                                @csrf
...
<div id="ModalExp" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form class="form-horizontal" method="POST" action="{{ route('ExMonevRnD') }}"
...
<div id="ModalCari" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="GET" action="{{ route('CariMonevRnD') }}" id='FrmCari'>
                @csrf
